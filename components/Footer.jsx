...
const Footer = () => {
  return (
    <div className={styles.footer}>
      ...
      <div className="flex flex-row w-full gap-10 justify-between"> {/* Full width and space between */}
        
        {/* Left Section: Contact Information */}
        <div className="flex-1 pl-10 pt-5">
            {/* Take up equal width */}
            <div className="flex items-center space-x-3 mb-5">
                <Image src="/icall.png" alt="Phone Icon" width={50} height={50} />
                <a href="tel:+9756471112" className="text-white">+9756471112</a>
            </div>
            <div className="flex items-center space-x-3 mb-5">
                <Image src="/im.png" alt="Email Icon" width={45} height={45} />
                <a href="mailto:tsiranghospital@gmail.com" className="text-white">tsiranghospital@gmail.com</a>
            </div>
            <div className="flex items-center space-x-3 mb-5">
                <Image src="/ifb1.png" alt="Facebook Icon" width={50} height={50} />
        ...
        <div className="flex-1 pr-10 pt-5"> {/* Take up equal width */}
          <p><Image src="/il.png" alt='image' width={40} height={40} />Our Location</p>
          <iframe
      ...
      <p className="text-lg text-center mt-7 mb-3">© 2024 Tsirang Hospital. All rights reserved.</p>
    </div>
  );
};
